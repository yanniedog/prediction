...
if __name__ == "__main__":
    ...
    excluded_filenames = {script_filename, 'cspell.json', 'parsetab.py', 'test_indicators.py', 'requirements.txt', 'restore_backup.py', 'REVERT-to-GPT-scripts.py', 'backup_cleanup.py', 'backup_utils.py', 'copyscripts.py', 'COPYSCRIPTS_SELECTIVE.py', 'repair-remarks.py', 'cspell.json', 'revert-to-gpt-scripts.py'}
