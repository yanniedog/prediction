...
if __name__ == "__main__":
    ...
    excluded_filenames = {script_filename, 'parsetab.py', 'backup_cleanup.py', 'backup_utils.py', 'config.py', 'generate_heatmaps.py', 'requirements.txt', 'copyscripts.py', 'COPYSCRIPTS_SELECTIVE.py', 'logging_setup.py' 'repair-remarks.py', 'visualization_utils.py', 'visualize_data.py', 'cspell.json', 'revert-to-gpt-scripts.py'}
    extensions = ['.py', '.ps']
    if args.extensions:
