...
from sqlite_data_manager import create_connection, initialize_database, create_tables
...
def main():
    ...
    if selected_indicator:
        ...
        if not configs:
            ...
            sys.exit(1)
        # Proceed to compute indicators based on configurations
        ...
        # Compute parameterized indicators
